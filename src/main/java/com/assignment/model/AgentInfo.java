...
public class AgentInfo {
    ...
    public String getDsoAccountNo() {
        return dsoAccountNo;
    }

    public void setDsoAccountNo(String dsoAccountNo) {
        this.dsoAccountNo = dsoAccountNo;
    }
    ...
    public void setAccountNo(String accountNo) {
        ...
        System.out.println("Agent Account set : " + this.accountNo);
    }
